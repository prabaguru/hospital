...
@Component({
  selector: "hospital-file-upload",
  templateUrl: "./file-upload.component.html",
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: FileUploadComponent3,
      multi: false,
    },
  ],
  styleUrls: ["./file-upload.component.scss"],
})
export class FileUploadComponent3 implements OnInit, ControlValueAccessor {
  @Input() progress;
  onChange: Function;
  myFiles: string[] = [];
  percentDone?: any = 0;
  ...
  submitForm() {
    ...
    this.apiService
      .uploadFile3(this.userData._id, this.form.value.file, imgUnlink)
      .subscribe(
        (event: HttpEvent<any>) => {
          switch (event.type) {
